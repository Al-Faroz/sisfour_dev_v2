...
class ProfileGuru extends BaseController
{
    ...
    {
        $result = $this->profileService->getGuruProfile(
            $this->actorUserId()
        );
        ...
        if (empty($result['success'])) {
            return $this->response
                ->setStatusCode(422)
                ->setBody(
                    $this->renderWithLayout('profile/guru', [
                        'title' => 'Profile Guru',
                        'profile' => null,
        ...
        return $this->response->setBody(
            $this->renderWithLayout('profile/guru', [
                ...
                'profileError' => null,
                'extraJs' => ['assets/js/profile/guru.js'],
            ])
        );
    }
    ...
    public function update()
    {
        ...
        return $this->respondResult(
            $this->profileService->updateGuruProfile(
                $this->actorUserId(),
    ...
    {
        return $this->respondResult(
            $this->profileService->uploadGuruFoto(
                $this->actorUserId(),
