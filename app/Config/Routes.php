 ...
 *
 * Konvensi filter:
 * - 'auth'              => Session-based (web), lihat AuthFilter (Tahap 3)
 * - 'auth:api'           => JWT-based (mobile), AuthFilter dengan argumen 'api'
 * - 'permission:key'     => Cek 1 permission_key
 * - 'permission:key1,key2' => Cek beberapa permission_key (OR — lolos jika punya salah satu)
 *
 * Dual-Output: Semua controller di bawah didesain mendukung ?format=json
 * atau endpoint /json terpisah (lihat masing-masing Controller).
 */

// ================================================================
// 1. AUTENTIKASI (WEB) — Tanpa Auth
// ================================================================
...
// ================================================================
// 2. AUTENTIKASI API (MOBILE) — Tanpa Auth (kecuali /me & /logout)
// ================================================================
...
// ================================================================
// 3. PUBLIC — Verifikasi QR Kartu Pelajar (Tanpa Auth)
// ================================================================
$routes->get('kartu/verify/(:segment)', 'KartuPelajar::verify/$1');

// ================================================================
// 4. PROTECTED WEB (auth + permission)
// ================================================================
