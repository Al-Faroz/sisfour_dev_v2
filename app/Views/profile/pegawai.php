...
<div id="profilePegawaiApp" data-base-url="<?= esc(base_url(), 'attr') ?>">
    ...
    <?php elseif (! empty($profile)): ?>
        ...
        $fotoUrl = $foto !== ''
            ? base_url('uploads/foto_pegawai/' . rawurlencode(basename($foto)))
            : '';
        ...
        <?php if (! empty($profile['jabatan_legacy'])): ?>
            <div class="alert alert-secondary d-flex align-items-start gap-2">
                ...
                <div>
                    <strong>Data jabatan lama tetap dipertahankan.</strong>
                    <div class="small mt-1">
                        <?= esc($profile['jabatan_legacy']) ?>. Gunakan
                        <strong>Riwayat &amp; Portofolio</strong> untuk mencatat penugasan/jabatan
                        beserta periode dan SK yang benar.
                    </div>
                </div>
            </div>
        <?php endif; ?>
                ...
                <div class="sisfour-profile-hero__body">
                    <div>
                        <img
                            ...
                            alt="Foto <?= esc($profile['nama'] ?? 'Pegawai', 'attr') ?>"
                    ...
                    <div class="sisfour-profile-identity">
                        <div class="d-flex flex-wrap align-items-center gap-2 mb-2">
                            <span class="badge bg-label-primary">Pegawai</span>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <form id="formFotoProfilePegawai">
                            <?= csrf_field() ?>
                            <label for="fotoProfilePegawai" class="form-label">Pilih Foto Baru</label>
                            <input
                                type="file"
                                class="form-control"
                                id="fotoProfilePegawai"
                                name="foto"
                                accept="image/png"
                                required
                            >
                        ...
                        <div class="alert alert-light border mt-4 mb-0 small">
                            ...
                            NIK, NIP dan status kepegawaian hanya dapat diubah melalui Master Pegawai.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-xl-8">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h5 class="mb-1">Biodata Pegawai</h5>
