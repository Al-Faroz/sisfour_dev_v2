                ...
                <div class="card-body">
                    <form method="get" class="row g-3 align-items-end">
                        <div class="col-12 col-md-4 col-lg-3">
                            ...
                            <select id="prestasiTahun" name="id_tahun" class="form-select" data-searchable-off="1" onchange="this.form.requestSubmit()">
                        ...
                        <div class="col-12 col-md-8">
                            <div class="form-text mb-2">Daftar langsung menampilkan Prestasi milik Anda pada Tahun Ajaran terpilih.</div>
                        </div>
                    </form>
                </div>
            </div>
