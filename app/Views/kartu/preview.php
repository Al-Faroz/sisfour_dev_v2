...
<div class="kartu-scroll mb-4">
    <div class="kartu-canvas kartu-front">
        <?php if ($photo_data_uri): ?>
            <div class="k-photo">
                <img
                    src="<?= esc($photo_data_uri) ?>"
                    alt="Foto"
                >
            </div>
        <?php endif; ?>
        ...
        <div class="k-meta">
            ...
            <div class="k-item">
                <span class="k-label">Jenis Kelamin</span>
                <?= esc($jenis_kelamin_display) ?>
            </div>

            <div class="k-item">
                <span class="k-label">Tahun Ajaran</span>
...
<div class="kartu-scroll mb-4">
    <div class="kartu-canvas kartu-back"></div>
</div>

<div class="card">
    <div class="card-body">
        <strong>QR Universal V1</strong>
        <div class="small text-muted mt-1">
            Aplikasi lain dapat mengambil NISN langsung dari payload;
            VERIFY dipakai bila perlu validasi ke SisisFour.
        </div>
        <code class="qr-payload d-block mt-2"><?= esc($qr_payload) ?></code>
        <a
            class="small"
            href="<?= esc($verify_url) ?>"
            target="_blank"
