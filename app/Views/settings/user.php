...
<div id="settingsUserApp" data-base-url="<?= esc(base_url()) ?>">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-5">
                    <input id="userSearch" class="form-control" placeholder="Cari username / nama / NISN">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-2 d-grid">
                    <button class="btn btn-outline-primary" id="btnUserCari">Tampilkan</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-text">Contoh valid: Guru + Operator, Guru + Pimpinan. Role primary tidak perlu dicentang lagi.</div>
                        </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="input-group">
                                <input id="identitySearch" class="form-control" placeholder="Nama / NIP / NISN">
                                <button type="button" class="btn btn-outline-secondary" id="btnIdentitySearch">Cari</button>
                            </div>
                            <select id="identityResult" class="form-select mt-2">
            ...
            <form class="modal-content" id="formResetPassword">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="password" type="password" minlength="8" class="form-control" required>
                    </div>
                    <div>
                        <label class="form-label">Konfirmasi Password</label>
                        <input name="password_confirmation" type="password" minlength="8" class="form-control" required>
                    </div>
                </div>
                <div class="modal-footer">
